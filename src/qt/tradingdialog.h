...
private slots:
    ...
    QString BuyGBC(QString OrderType, double Quantity, double Rate);
    QString SellGBC(QString OrderType, double Quantity, double Rate);
